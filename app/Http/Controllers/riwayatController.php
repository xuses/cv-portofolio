...
class riwayatController extends Controller
{
    ...
    function update(Request $request)
    {
        $request->validate([
            ...
            '_foto.mimes' => 'Silahkan masukan file foto dengan format JPEG, JPG, PNG dan GIF',
        ...
        return redirect()->route('riwayat.index')->with('success', 'Berhasil update data riwayat');
    }
}
